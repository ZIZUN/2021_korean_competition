...
from transformers import GPT2ForSequenceClassification,GPT2Config, RobertaForSequenceClassification, \
    RobertaConfig, RobertaForMultipleChoice, RobertaModel
from util.trainer import Trainer
from util.dataset import LoadDataset_wic
...
trainer = Trainer('wic', model, train_dataloader=train_data_loader, test_dataloader=test_data_loader,
