...
elif args.model == 'kcbert':
    model_config = BertConfig.from_pretrained(pretrained_model_name_or_path="beomi/kcbert-large",
                                              num_labels=2)
    model = BertForSequenceClassification.from_pretrained("beomi/kcbert-large", config=model_config) # klue/roberta-large
...
trainer = Trainer('cola', model, train_dataloader=train_data_loader, test_dataloader=test_data_loader,
